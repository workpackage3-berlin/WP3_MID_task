...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='/Users/charlotte/Dropbox/Charite_PhD/tasks/MID_new_version/MID_v6.py',
    ...
    for thisMainLoop in MainLoop:
        ...
        while continueRoutine and routineTimer.getTime() < 0.5:
            ...
            if LatePress_blankScreen.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
                ...
                win.callOnFlip(LatePress_blankScreen.clearEvents, eventType='keyboard')  # clear events on next screen flip
        ...
        if LatePress_feedback.keys == None and button_pressed == 0:
            resp = "No response"
            print("Response: [%s]" % resp)    
            outlet.push_sample([resp])  # Push event marker. 
